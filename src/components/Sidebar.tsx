    ...
    <aside className="w-64 bg-navy-950 border-r border-slate-800/50 flex flex-col h-full">
      ...
      <div className="p-5 border-b border-slate-800/50">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-carbon-500 to-pulse-500 flex items-center justify-center">
      ...
      <div className="p-4 border-t border-slate-800/50">
        <div className="bg-navy-900 rounded-lg p-3 gradient-border">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-2 h-2 rounded-full bg-carbon-400 animate-pulse"></div>
            <span className="text-xs font-medium text-carbon-400">AI Engine Active</span>
          </div>
      ...
      <div className="p-4 border-t border-slate-800/50">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-carbon-600 to-blue-600 flex items-center justify-center text-white text-xs font-bold">
            CP
          </div>
          <div>
            <p className="text-sm font-medium text-slate-200">Admin</p>
            <p className="text-xs text-slate-500">Network Manager</p>
          </div>
        </div>
      </div>
    </aside>
